...
```{r mod_plot_all}
mod_plot_all <- tab_app_ch2('mod_plot_all', 'Posterior estimates (median log-odds, 90th HDPI) of the plot-level infection risk model assessed among all host species.')
...
```{r mod_plot_HS}
mod_plot_HS <- tab_app_ch2('mod_plot_HS', 'Posterior estimates (median log-odds, 90th HDPI) of the plot-level infection risk model assessed among commonly symptomatic species.')
